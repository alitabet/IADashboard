...
public class PatentDataLookupableImpl extends LookupableImpl {
    ...
    public Collection<?> performSearch(LookupForm form, Map<String, String> searchCriteria, boolean bounded) {
    	...
    	stringKeys.add("publicationNumber"); stringKeys.add("awardNumber"); 
    	stringKeys.add("source"); stringKeys.add("facultyNames");
